...
\newcommand{\method}[1]{\textbf{\texttt{\detokenize{#1}}}}
\newcommand{\desc}[1]{\ \ \ \texttt{\detokenize{#1}}}
\newcommand{\className}[1]{\large \textbf{\detokenize{#1}}}
\newcommand{\data}[1]{\textbf{\texttt{\detokenize{#1}}}}
...
\node[rootClass ] (Map) [right=of World] {
...
\if\showEssentialClasses1
	...
	\node[essentialClass, wideBox ] (RigidPhysicalObject) [right=of Position] {
...
\if\showExampleClasses1
	...
	\node[exampleClass ] (RigidPointBall) [below=of RigidPhysicalObject] {
